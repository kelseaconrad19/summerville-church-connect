  ...
  return (
    <div>
      <PageHeader 
        ...
        backgroundImage="/images/contact4.jpg"
      />
                  ...
                  <CardContent className="p-6">
                    ...
                    <div className="space-y-4">
                      <div>
                        ...
                        <p className="text-gray-700">413 Old Trolley Rd<br />Summerville, SC 29485</p>
                      </div>
                      <div>
                        <h4 className="font-semibold">Phone</h4>
                        <p className="text-gray-700">(843) 873-1517</p>
                      </div>
                      <div>
                        <h4 className="font-semibold">Email</h4>
                        <p className="text-gray-700">office@summervillechurchofchrist.org</p>
                      </div>
                    </div>
                  </CardContent>
                </Card>
                ...
                <Card>
                  <CardContent className="p-6">
                    ...
                    <div className="flex space-x-4">
                      ...
                      <a href="https://www.youtube.com/@SummervilleChurchofChrist" className="text-gray-500 hover:text-church-blue">
